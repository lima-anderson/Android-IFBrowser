...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btCriadorDeCores: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.btCriadorDeCores = findViewById(R.id.btCriadorDeCores)
        ...
        this.btCriadorDeCores.setOnClickListener{ abrirCriadorDeCores() }
    ...
    private fun abrirCriadorDeCores(){
        val intent = Intent("CriadorDeCores")

        if (intent.resolveActivity(packageManager) != null) {
            startActivity(intent)
        } else {
            Toast.makeText(this, "Erro Feio", Toast.LENGTH_SHORT).show()
        }
    }
}